...
public class CreateGiantSession extends HttpServlet
{
    MainBean theBean;
            ...
            throws ServletException, IOException
    {
        ...
        String modelContents = getXmlContents();

        Session session = new Session(sessionId, "giant-model.xml", modelContents,
    ...
    private static String getXmlContents()
    {
        InputStream modelStream = CreateGiantSession.class.
                getResourceAsStream("/rawi/resources/giant-model.xml");
        ...
        {
            Logger.getLogger(CreateGiantSession.class.getName()).log(Level.SEVERE, null, ex);
        }
            ...
            throws ServletException, IOException
    {
        ...
        try {
            ...
            msi.createGiantTestSession(sessionInfo);
